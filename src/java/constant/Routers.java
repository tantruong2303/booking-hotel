...
public class Routers {
	...
	public final static String ADD_BOOKING_INFO = "/BookingHotel/AddBookingInfo";
	public final static String ADD_REVIEW = "/BookingHotel/AddReview";
	public final static String ADD_ROOM = "/BookingHotel/AddRoom";
	public final static String CANCEL_BOOKING_INFO = "/BookingHotel/CancelBookingInfo";
	public final static String CHANGE_PASSWORD = "/BookingHotel/ChangePassword";
	...
	public final static String VIEW_USER_INFO = "/BookingHotel/ViewUserInfo";
	public final static String ERROR = "/BookingHotel/error.jsp";
}
