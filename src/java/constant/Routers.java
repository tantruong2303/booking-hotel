...
public class Routers {
    ...
    public final static String NOT_FOUND_PAGE = "notFound.jsp";
    ...
    public final static String CANCEL_BOOKING_INFO = "/CancelBookingInfo";
    ...
    public final static String LIST_ROOM = "/RoomList";
    public final static String UPDATE_ROOM = "/UpdateRoom";
    public final static String UPDATE_USER_INFO = "/UpdateUserInfo";
    public final static String VIEW_USER_INFO = "/ViewUserInfo";
