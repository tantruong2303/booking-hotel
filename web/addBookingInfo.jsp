							...
							<div class="flex-1 px-2">
								...
								<div>
									<form method="POST" action="/AddBookingInfo?roomId=<%=room.getRoomId() %>">
										...
										<button class="ext-center block col-start-2 px-16 py-2 mt-8 font-semibold text-white duration-300 bg-gray-800 rounded-sm hover:bg-gray-600">Booking Now</button>
									</form>
								</div>
