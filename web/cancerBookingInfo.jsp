<%-- 
    Document   : cancerBookingInfo
    Created on : May 27, 2021, 7:36:09 PM
    Author     : Lenovo
--%>
...
<html>
    ...
    <body >
        <%
            String bookingInfoIdError = (String) request.getAttribute("bookingInfoIdError");



            if (bookingInfoIdError == null) {
                bookingInfoIdError = "";
            }
