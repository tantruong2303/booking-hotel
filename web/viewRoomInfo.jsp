<%-- Document : ViewRoomInfo Created on : May 28, 2021, 6:14:12 PM Author : heaty566 --%> <%@page import="dtos.Room"%> <%@page
import="utils.GetParam"%> <%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
        <head>
        ...
        <body class="flex flex-col min-h-screen">
                <% Room room =(Room) GetParam.getClientAttribute(request,"room", "" ); String errorMessage =(String)
                GetParam.getClientAttribute(request, "errorMessage", ""); %> <%@include file="./includes/navbar.jsp" %>
                                ...
                                <div class="space-y-4">
                                        ...
                                        <div class="py-2 border-t-2">
                                                <form class="flex items-center space-x-2">
                                                        <label class="block w-32 font-medium" for="username">My Feedback</label>
                                                        <input
                                                                type="text"
