<%@page contentType="text/html" pageEncoding="UTF-8"%> <%@page import="utils.GetParam"%> <%@page import="dtos.RoomType"%> <%@page
import="java.util.ArrayList"%> <%@page import="utils.Validator"%> <% Float price =(Float) GetParam.getClientParams(request,"priceError", 0f); String
description=(String) GetParam.getClientParams(request,"description", ""); String roomId=(String) GetParam.getClientParams(request,"roomId", "");
String photoError =(String) GetParam.getClientAttribute(request,"photoError", ""); String priceError =(String)
GetParam.getClientAttribute(request,"priceError", ""); String roomIdError =(String) GetParam.getClientAttribute(request,"roomIdError", ""); String
isDisableError =(String) GetParam.getClientAttribute(request,"stateError", ""); String errorMessage =(String)
GetParam.getClientAttribute(request,"errorMessage", ""); String descriptionError =(String) GetParam.getClientAttribute(request,"descriptionError",
""); String roomTypeIdError =(String) GetParam.getClientAttribute(request,"roomTypeIdError", ""); ArrayList<RoomType>
        roomTypes =(ArrayList<RoomType
                >) GetParam.getClientAttribute(request,"roomTypes", new ArrayList<>()); %>
                <!DOCTYPE html>
                <html>
                        <head>
