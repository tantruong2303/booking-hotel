				...
				<div   class="mt-8 space-y-8 fade-in ">
					...
					<div class="space-y-2">
						...
						<div class="flex space-x-2">
							<a  href="UpdateUserController" class="block col-start-2 p-2 mt-8 font-semibold text-center text-white duration-300 bg-gray-800 rounded-sm hover:bg-gray-600" />Update Information</a>

							<a  href="ChangePasswordController" class="block col-start-2 p-2 mt-8 font-semibold text-center text-white duration-300 bg-gray-800 rounded-sm hover:bg-gray-600" />Change Password</a>
						</div>
